...
def main():
    ...
    # parser.add_argument('--partition_index', type=int, default=4, 
    #                     help='the partition of networks') 
    parser.add_argument('--init_par', type=float, default=0, 
    ...
    parser.add_argument('--analyze_freq', type=int, default=1, 
                        help='the frequence to evaluate the network')
    parser.add_argument('--verbose', action='store_true', default=True,
                        help='show the training and evaluation details',)       

    # arguments for risk evluation 
    parser.add_argument('--analyze_batch_size', type=int, default=50, 
